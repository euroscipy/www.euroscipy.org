...
AUTHOR = 'The EuroSciPy team <info@euroscipy.org>'
SITENAME = 'EuroSciPy'
SITEURL = ''
...
SUBMENU['euroscipy_2020'] = [
    ('Euroscipy 2020', '2020/'),
    #  ('Program', '2020/program.html'),
    #  ('Maintainers', '2020/maintainers.html'),
    ('Venue', '2020/venue.html'),
    #  ('Events', '2020/networking.html'),
    ('Sponsor', '2020/sponsors.html'),
    ('FAQ', '2020/faq.html'),
    ('CoC', '2020/code_of_conduct.html'),
    ('About', '2020/about.html'),
]
